...
@NoArgsConstructor
@AllArgsConstructor
public class SystemUserVO extends SearchVo {
	...
	public void setSearchVo( SearchVo searchVo ){
		...
		this.searchField = SystemUserEnum.of(searchVo.getSearchField()).toString();
		this.searchValue = searchVo.getSearchValue();
		
		this.searchField1 = SystemUserEnum.of(searchVo.getSearchField1()).toString();
		this.searchValue1 = searchVo.getSearchValue1();
		
		this.searchField3  = SystemUserEnum.of(searchVo.getSearchField3()).toString();
		this.searchValue3  = searchVo.getSearchValue3();
		
		this.seqListField  = SystemUserEnum.of(searchVo.getSeqListField()).toString();
		this.seqList  = searchVo.getSeqList();
		
		this.orderByField  = SystemUserEnum.of(searchVo.getOrderByField()).toString();
